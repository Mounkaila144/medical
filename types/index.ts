...
export interface Tariff extends BaseEntity {
  code: string;
  name: string;
  description?: string;
...
export interface AppointmentForm {
  ...
  endAt: string;
  reason: string;
  urgency: "ROUTINE" | "URGENT"; // Valeurs acceptées par le backend
  notes?: string;
  room?: string;
  // status est automatiquement défini à SCHEDULED par le backend lors de la création
  status?: string; // Seulement pour les mises à jour
  cancellationReason?: string;
}
