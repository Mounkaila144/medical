  ...
  async function onSubmit(data: RegisterFormValues) {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to MediSync! Your account has been created.",
      });
      ...
      <div className="mx-auto grid w-full max-w-md gap-6">
        <div className="flex flex-col space-y-2 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Entrer votre information pour commencer avec MediSync
          </p>
        </div>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Nom de votre clinique" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="receptionist">Receptioniste</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
